...
if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['first']) or empty($_POST['last']) or empty($_POST['suffix'])) {
        ...
        $flag1 = 1;
        $name = $_POST['title_t'] . " " . $_POST['first'] . " " . $_POST['last'] . " " . $_POST['suffix'];
    }
...
if ($flag == 1 and $flag1 == 1 and $flag2 == 1 and $flag3 == 1 and $flag4 == 1 and $flag5 == 1 and $flag6 == 1 and $flag7 == 1 and $flag8 == 1 and $flag9 == 1) {
    ...
    // $sql = "INSERT INTO register_first VALUES (NULL ,'$name','$address','$address1','$citys','$states','$zip','$countrys','$emails','$numbers', NULL)";
    ...
    $object->insert('register_first', ['name' => $name, 'address1' => $address, 'address2' => $address1, 'city' => $citys, 'state' => $states, 'zipcode' => $zip, 'country' => $countrys, 'email' => $emails, 'mobilenumber' => $numbers]);
                    ...
                    <div>
                        ...
                        <span class="left zip">
                            <input id="zip_code" name="zip_code" type="text" class="field text addr" size="6"
                                maxlength="6" tabindex="0" placeholder="" value="<?php
                                if (isset($_POST['submit'])) {
                                    echo $zip;
                                }
                                ?>">
