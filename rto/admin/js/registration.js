...
$('form').submit(function () {
    ...
    var validation = true;
    var error_fullname = error_fathername = error_gender = error_dob = error_bloodgroup = error_phonenumber = error_email = error_password = error_address1 = error_address2 = error_aadhernumber = error_licensetype = error_photo = error_state = error_district = error_city = error_pincode = "";
    $('#error_fullname').hide();
    ...
    //     if (!nameValid.test($('#address1').val())) {
    //         $('#error_address1').show();
    //         error_address1 = "*Address Line 1 Not Valid";
    //         validation = false;
    //     }
    // }
    ...
    // else {
    //     var nameValid = /^[a-zA-z0-9]*$/;
    //     if (!nameValid.test($('#address2').val())) {
    //         $('#error_address2').show();
    //         error_address2 = "*Address Line 2 Not Valid";
    //         validation = false;
    //     }
    // }
