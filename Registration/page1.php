<?php
$flag = $flag1 = $flag2 = $flag3 = $flag4 = $flag5 = $flag6 = $flag7 = $flag8 = $flag9 = 0;
$titleErr = $nameErr = $addressErr = $address2Err = $cityErr = $stateErr = $zipErr = $countryErr = $emailErr = $numberErr = "";
...
if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['first']) or empty($_POST['last']) or empty($_POST['suffix'])) {
        $nameErr = "Name is empty";
    } elseif (!preg_match("/^[a-zA-z]*$/", $_POST['first']) or !preg_match("/^[a-zA-z]*$/", $_POST['last']) or !preg_match("/^[a-zA-z]*$/", $_POST['suffix'])) {
...
<body>
    ...
    <div class="container">
        ...
        <form method="post" class="form" accept="<?php $_SERVER['PHP_SELF']; ?>">
            ...
            <ul>
                <li id="row1" class="row1">
                    ...
                    <span>
                        <input id="title" name="title_t" type="text" class="field text" size="2" tabindex="0"
                            placeholder="" value="<?php
                            if (isset($_POST['submit'])) {
                                echo $title;
                            }
                            ?>"><br>
                        <label for="title" class="text1">Title</label>
                    </span>
                    <span>
                    ...
                    <span>
                        <input id="suffix" name="suffix" type="text" class="field text" size="3" tabindex="0"
                            placeholder="" value="<?php
                            if (isset($_POST['submit'])) {
                                echo $suffix;
                            }
                            ?>"><br>
                        <label for="suffix" class="text1">Suffix</label>
                    </span>
                </li>
                <span class="error">
                    ...
                    <div>
                        ...
                        <span class="left zip">
                            <input id="zip_code" name="zip_code" type="text" class="field text addr" maxlength="15"
                                tabindex="0" placeholder="" value="<?php
                                if (isset($_POST['submit'])) {
                                    echo $zip;
                                }
                                ?>">
                ...
                <li id="row3" class="row3">
                    ...
                    <div>
                        <input id="email_id" name="email_id" type="email" spellcheck="false" class="field text medium"
                            maxlength="255" tabindex="0" value="<?php
                            if (isset($_POST['submit'])) {
                                echo $email;
                            }
                            ?>">
    ...
    <form id="hiddenform" action="page2.php" method="post"> 
        <input type="hidden" name="title" value="<?php echo $title?>">
        <input type="hidden" name="first_f" value="<?php echo $first?>">
        <input type="hidden" name="last_l" value="<?php echo $last?>">
        <input type="hidden" name="suffix_s" value="<?php echo $suffix?>">
        <input type="hidden" name="address1" value="<?php echo $address?>">
        <input type="hidden" name="address2" value="<?php echo $address2?>">
        <input type="hidden" name="city_c" value="<?php echo $city ?>">
        <input type="hidden" name="state_s" value="<?php echo $state ?>">
        <input type="hidden" name="zip_z" value="<?php echo $zip ?>">
        <input type="hidden" name="country_c" value="<?php echo $country ?>">
        <input type="hidden" name="email_e" value="<?php echo $email ?>">
        <input type="hidden" name="number_1" value="<?php echo $number ?>">
        <input type="hidden" name="number_2" value="<?php echo $number_1 ?>">
        <input type="hidden" name="number_3" value="<?php echo $number_2 ?>">
    </form>
