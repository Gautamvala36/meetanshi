$(document).ready(function () {
    $("#sava_edit").click(function () {
        var status = $(this).closest("#myform").find("#first-toggle-btn").val();
        ...
        $.ajax({
            ...
            data: {
                status1: status, email_id: email, outlet_name: outletname, admin_name: adminname, first_name: firstname,
